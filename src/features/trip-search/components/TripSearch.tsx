  ...
  return (
    <section className="relative bg-gradient-to-br from-aqua-500 via-aqua-400 to-sand-300 px-4 pt-24 pb-8">
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <form role="search" onSubmit={handleSubmit} className="w-full max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-6 md:p-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="flex flex-col">
              ...
              <input
                ...
                onChange={(e) => handleSearch('departure', e.target.value)}
