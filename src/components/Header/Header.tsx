      ...
      <nav className="max-w-7xl mx-auto flex items-center justify-between p-4">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <div className="relative">
            ...
            <button
              type="button"
              className="relative text-sm text-gray-800 font-regular bg-white/30 rounded-2xl px-4 py-1 hover:text-purple-600 hover:bg-white/40 cursor-pointer transition-all"
            >
              Publish A Trip
            </button>
          </div>
